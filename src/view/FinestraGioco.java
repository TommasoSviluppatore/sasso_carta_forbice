...
public class FinestraGioco extends JFrame {
	...
	public FinestraGioco() {
		...
		ImageIcon imagForbice=new ImageIcon(FinestraGioco.class.getResource("/forbice.jpg"));
		...
		ImageIcon imagSasso=new ImageIcon(FinestraGioco.class.getResource("/sasso.jpg"));
		this.btnSasso.setIcon(imagSasso);
		pannelloInput.add(btnSasso);
		
		btnCarta = new JButton("Carta");
		btnCarta.setBounds(292, 12, 110, 90);
		ImageIcon imagCarta=new ImageIcon(FinestraGioco.class.getResource("/carta.jpg"));
